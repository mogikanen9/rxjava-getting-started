...
public class CreateThread {
	...
	public static void main(String[] args) {
		...
		Runnable r2 = () -> System.out
				.println("Hello from " + Thread.currentThread().getName() + " USING LAMBDA " + "notation");
		/*
		 * Create and start a thread using the first runnable object This thread
		 * is also given a name in the arguments
		 */
